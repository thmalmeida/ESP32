...
//	tmElements_t tm;
	...
	const uint8_t timer_motorStart1 = 35;	// delay on transition of k3 off and k2 on
	const uint16_t timer_motorStart2 = 200;	// delay on transition of k3 off and k2 on
...
//			break;
//
//		case 3:	// Partida estrela/tringulo
//			k1_on();
//			k3_on();
//			//wdt_reset();
//			_delay_ms(((double) 100.0*timer_motorStart1));
//			//wdt_reset();
//
//			k3_off();
//			uint32_t countK = 0;
...
//		eeprom.write(eeprom.pageSet, eeprom.addr_PRessureRef, 99);
